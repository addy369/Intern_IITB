...
test_data=train(os.path.join(data_dir,'train_back2'))
...
def train_model(model, criterion_1,criterion_2,optimizer, scheduler, num_epochs=50,alpha=-0.5):
    since = time.time()
...
model_ft = train_model(my_model,criterion_1,criterion_2,optimizer_ft, exp_lr_scheduler,num_epochs=50,alpha=-1)
